...
<head>
    ...
    <title>FoodFinder - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2024 All rights reserved. Made with &#x1F49C; by <b><a>TEAM</a></b> VIRAL-SAURAV </a></b></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
